library Hex requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_HEX
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Hex extends CrowdControl
        private static constant integer buff = 'BU07'
        private static constant integer ability = 'U007'
        private static constant string order = "hex"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_HEX = RegisterCrowdControl(thistype.allocate())
