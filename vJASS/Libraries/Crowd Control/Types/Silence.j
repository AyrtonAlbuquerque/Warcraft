library Silence requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_SILENCE
    endglobals
    
    /* ----------------------------------------------------------------------------------------- */
    /*                                          JASS API                                         */
    /* ----------------------------------------------------------------------------------------- */
    function SilenceUnit takes unit source, unit target, real duration, string model, string point, boolean stack returns nothing
        call CrowdControl.apply(CROWD_CONTROL_SILENCE, source, target, 0, 0, duration, model, point, stack)
    endfunction
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Silence extends CrowdControl
        private static constant integer buff = 'BU00'
        private static constant integer ability = 'U000'
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_SILENCE = RegisterCrowdControl(thistype.allocate())
