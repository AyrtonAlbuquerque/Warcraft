library Cyclone requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_CYCLONE
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Cyclone extends CrowdControl
        private static constant integer buff = 'BU09'
        private static constant integer ability = 'U009'
        private static constant string order = "cyclone"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_CYCLONE = RegisterCrowdControl(thistype.allocate())
