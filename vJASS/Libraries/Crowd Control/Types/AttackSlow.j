library AttackSlow requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_SLOW_ATTACK
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct AttackSlow extends CrowdControl
        private static constant integer buff = 'BU02'
        private static constant integer ability = 'U002'
        ...
        method start takes unit source, unit target, real value, real angle, real duration, string model, string point, boolean stack returns boolean
            ...
            if duration > 0 and target != null then
                ...
                call BlzSetAbilityRealLevelField(spell, ABILITY_RLF_ATTACK_SPEED_REDUCTION_PERCENT_CRI2, 0, value)
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_SLOW_ATTACK = RegisterCrowdControl(thistype.allocate())
