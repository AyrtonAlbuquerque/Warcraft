scope Entangle
    globals
        integer CROWD_CONTROL_ENTANGLE
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Entangle extends CrowdControl
        private static constant integer buff = 'BU10'
        private static constant integer ability = 'U010'
        private static constant string order = "entanglingroots"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_ENTANGLE = RegisterCrowdControl(thistype.allocate())
