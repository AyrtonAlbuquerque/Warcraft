library Banish requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_BANISH
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Banish extends CrowdControl
        private static constant integer buff = 'BU04'
        private static constant integer ability = 'U004'
        private static constant string order = "banish"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_BANISH = RegisterCrowdControl(thistype.allocate())
