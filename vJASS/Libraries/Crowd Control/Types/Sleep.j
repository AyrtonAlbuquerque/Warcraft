library Sleep requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_SLEEP
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Sleep extends CrowdControl
        private static constant integer buff = 'BU08'
        private static constant integer ability = 'U008'
        private static constant string order = "sleep"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_SLEEP = RegisterCrowdControl(thistype.allocate())
