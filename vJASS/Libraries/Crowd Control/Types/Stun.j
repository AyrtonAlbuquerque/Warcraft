library Stun requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_STUN
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Stun extends CrowdControl
        private static constant integer buff = 'BU01'
        private static constant integer ability = 'U001'
        private static constant string order = "thunderbolt"
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_STUN = RegisterCrowdControl(thistype.allocate())
