library Disarm requires CrowdControl, Indexer, Dummy, Utilities
    globals
        integer CROWD_CONTROL_DISARM
    endglobals
    ...
    /*                                           System                                          */
    /* ----------------------------------------------------------------------------------------- */
    private struct Disarm extends CrowdControl
        private static constant integer buff = 'BU11'
        private static constant integer ability = 'U011'
        ...
        private static method onInit takes nothing returns nothing
            set CROWD_CONTROL_DISARM = RegisterCrowdControl(thistype.allocate())
