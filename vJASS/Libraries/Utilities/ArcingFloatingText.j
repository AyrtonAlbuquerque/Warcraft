library ArcingFloatingText
    globals
        ...
        private constant    real    SIZE_BONUS      = 0.            // Text size increase
    ...
    struct ArcingTextTag extends array
        ...
        private static method update takes nothing returns nothing
            ...
            loop
                ...
                call SetTextTagText(.tt, .s, .size + SIZE_BONUS * p)
                if .t <= 0 then
                    set .tt = null
        ...
        public static method create takes string s, unit u, real size returns thistype
