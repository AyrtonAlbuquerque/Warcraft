    ...
    //=====================================================================================
        ...
        function UnitStackItem takes unit u, item i returns boolean
            ...
            if ic <= 0 then
                ...
                call DisableTrigger( gg_trg_EasyItemStackSplit )
                call UnitAddItem( u, i )
                call EnableTrigger( gg_trg_EasyItemStackSplit )
            else
                // Set vars
        ...
        private function onInit takes nothing returns nothing
            ...
            local integer x = 0
            set gg_trg_EasyItemStackSplit = CreateTrigger()
            loop
                call TriggerRegisterPlayerUnitEvent( gg_trg_EasyItemStackSplit, Player(x), EVENT_PLAYER_UNIT_PICKUP_ITEM, null )
                call TriggerRegisterPlayerUnitEvent( gg_trg_EasyItemStackSplit, Player(x), EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER, null )
            ...
            call TriggerAddCondition( gg_trg_EasyItemStackSplit, function ActionController )
