scope Intelligence
    ...
    private struct Intelligence extends Bonus
        private static constant integer ability = 'Z003'
        private static constant abilityintegerlevelfield field = ABILITY_ILF_INTELLIGENCE_BONUS
        ...
        private static method onInit takes nothing returns nothing
            set BONUS_INTELLIGENCE = RegisterBonus(thistype.allocate())
        endmethod
    endstruct
endscope