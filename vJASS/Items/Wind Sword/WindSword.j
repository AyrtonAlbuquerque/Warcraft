scope WindSword
    ...
    struct WindSword extends Item
        ...
        private method onTooltip takes unit u, item i, integer id returns string
            return "|cffffcc00Gives:|r\n+ |cffffcc00300|r Damage\n\n|cff00ff00Passive|r: |cffffcc00Godspeed|r: Attacking grants |cffffcc0020%%|r Attack Speed and |cffffcc008%%|r Movement Speed bonus.\n\n|cff00ff00Passive|r: |cffffcc00Wind Blow|r: Attacks have |cffffcc0020%%|r chance to knockback the target |cffffcc00200|r units over |cffffcc000.5|r seconds and deal |cff00ffff" + N2S(GetDamage(), 0) + " Magic|r damage."
        endmethod
        ...
        private static method onInit takes nothing returns nothing
            ...
            call RegisterItem(allocate(code), OrbOfWind.code, GoldenSword.code, 0, 0, 0)
        endmethod
    endstruct
endscope