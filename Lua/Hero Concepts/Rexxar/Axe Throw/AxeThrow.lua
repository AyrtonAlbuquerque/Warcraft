--[[requires SpellEffectEvent, PluginSpellEffect, Missiles, Utilities
                ...
                this.onHit = function(unit)
                    if UnitAlive(unit) then
                        if DamageFilter(this.owner, unit) then
                            if UnitDamageTarget(this.source, unit, false, false, ATTACK_TYPE_NORMAL, DAMAGE_TYPE_MAGIC, nil) then
                                print("here")
                                ...
                                if UnitAlive(unit) then
                                    ...
                                    SlowUnit(unit, this.slow, this.time)
                                end
                            end
                        end
                    end
...
end--[[requires SpellEffectEvent, PluginSpellEffect, Missiles, Utilities
    /* ----------------------- Axe Throw v1.0 by Chopinski ---------------------- */
    // Credits:
    //     -Berz-          - Icon
    //     Bribe           - SpellEffectEvent
