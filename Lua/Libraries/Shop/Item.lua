...
OnInit("Item", function(requires)
    ...
    Item:property("pierce", { get = function (self) return 0 end })
    Item:property("damage", { get = function (self) return 0 end })
    Item:property("health", { get = function (self) return 0 end })
    Item:property("healing", { get = function (self) return 0 end })
    ...
    Item:property("ominivamp", { get = function (self) return 0 end })
    Item:property("shielding", { get = function (self) return 0 end })
    ...
    Item:property("healingReduction", { get = function (self) return 0 end })
    Item:property("armorPenetration", { get = function (self) return 0 end })
    Item:property("magicPenetration", { get = function (self) return 0 end })
    Item:property("cooldownReduction", { get = function (self) return 0 end })
    Item:property("shieldingReduction", { get = function (self) return 0 end })
    Item:property("armorPenetrationFlat", { get = function (self) return 0 end })
    ...
    function Item.onPickupItem()
        ...
        if itempool[id] then
            ...
            if Bonus then
                ...
                LinkBonusToItem(unit, BONUS_HEALING, this.healing, item)
                LinkBonusToItem(unit, BONUS_HEALING_REDUCTION, this.healingReduction, item)
                LinkBonusToItem(unit, BONUS_SHIELDING, this.shielding, item)
                LinkBonusToItem(unit, BONUS_SHIELDING_REDUCTION, this.shieldingReduction, item)
                ...
                LinkBonusToItem(unit, BONUS_PIERCE_CHANCE, this.pierce, item)
                ...
                LinkBonusToItem(unit, BONUS_OMNIVAMP, this.ominivamp, item)
