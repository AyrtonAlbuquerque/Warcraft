...
function SubString(source, start, finish)
end
...
-- Map Setup API
--
--  These are function functions for describing the map configuration
...
function GroupEnumUnitsOfType                (whichGroup, name, filter)
end
function GroupEnumUnitsOfPlayer              (whichGroup, whichPlayer, filter)
end
function GroupEnumUnitsOfTypeCounted         (whichGroup, name, filter, countLimit)
end
...
-- This function is asynchronous. The values it) end are not guaranteed synchronous between each player.
...
--) end full map bounds, including unplayable borders, in world coordinates
...
--function string GetTriggeringVariableName() end
...
-- For EVENT_PLAYER_UNIT_PICKUP_ITEM,) end the item absorbing the picked up item in case it is stacking.
--) end null if the item was a powerup and not a stacking item.
function BlzGetAbsorbingItem()
end
function BlzGetManipulatedItemWasAbsorbed()
end

-- EVENT_PLAYER_UNIT_STACK_ITEM
-- Source is the item that is losing charges, Target is the item getting charges.
function BlzGetStackingItemSource()
end
function BlzGetStackingItemTarget()
end
function BlzGetStackingItemTargetPreviousCharges()
end
...
--) end the actual string they typed in ( same as what you registered for
-- if you required exact match )
function GetEventPlayerChatString()
end

--) end the string that you registered for
...
--) end handle to unit which triggered the most recent event when called from
...
function SetItemDropID  (whichItem, Id)
end
...
-- Unit API
-- Facing arguments are specified in degrees
function CreateUnit             (playerId, unitId, x, y, face)
end
function CreateUnitByName       (whichPlayer, name, x, y, face)
end
function CreateUnitAtLoc        (playerId, unitId, whichLocation, face)
end
function CreateUnitAtLocByName  (id, name, whichLocation, face)
end
function CreateCorpse           (whichPlayer, id, x, y, face)
end
...
function UnitAddItemById        (whichUnit, Id)
end
function UnitAddItemToSlotById  (whichUnit, Id, Slot)
end
function UnitRemoveItem         (whichUnit, whichItem)
end
function UnitRemoveItemFromSlot (whichUnit, Slot)
end
function UnitHasItem            (whichUnit, whichItem)
end
function UnitItemInSlot         (whichUnit, Slot)
end
...
function UnitAddAbility              (whichUnit, Id)
end
function UnitRemoveAbility           (whichUnit, Id)
end
function UnitMakeAbilityPermanent    (whichUnit, permanent, Id)
end
...
function IssueBuildOrder             (whichPeon, ToBuild, x, y)
end
function IssueBuildOrderById         (whichPeon, Id, x, y)
end

function IssueNeutralImmediateOrder      (forWhichPlayer, neutralStructure, ToBuild)
end
function IssueNeutralImmediateOrderById  (forWhichPlayer, neutralStructure, Id)
end
function IssueNeutralPointOrder          (forWhichPlayer, neutralStructure, ToBuild, x, y)
end
function IssueNeutralPointOrderById      (forWhichPlayer, neutralStructure, Id, x, y)
end
function IssueNeutralTargetOrder         (forWhichPlayer, neutralStructure, ToBuild, target)
end
function IssueNeutralTargetOrderById     (forWhichPlayer, neutralStructure, Id, target)
end
...
function AddItemToStock              (whichUnit, Id, currentStock, stockMax)
end
function AddUnitToAllStock           (unitId, currentStock, stockMax)
end
function AddUnitToStock              (whichUnit, Id, currentStock, stockMax)
end

function RemoveItemFromAllStock      (itemId)
end
function RemoveItemFromStock         (whichUnit, Id)
end
function RemoveUnitFromAllStock      (unitId)
end
function RemoveUnitFromStock         (whichUnit, Id)
end
...
function GetPlayerTypedUnitCount(whichPlayer, Name, includeIncomplete, includeUpgrades)
end
...
function DialogAddButton             (whichDialog, Text, hotkey)
end
function DialogAddQuitButton         (whichDialog, doScoreScreen, Text, hotkey)
end
...
function UnitPoolAddUnitType     (whichPool, Id, weight)
end
function UnitPoolRemoveUnitType  (whichPool, Id)
end
...
function ItemPoolAddItemType     (whichItemPool, Id, weight)
end
function ItemPoolRemoveItemType  (whichItemPool, Id)
end
...
function SetDayNightModels           (terrainDNCFile, DNCFile)
end
...
function TimerDialogSetRealTimeRemaining (whichDialog, emaining)
end
...
function CameraSetupApplyForceDuration       (whichSetup, doPan, Duration)
end
function CameraSetupApplyForceDurationWithZ  (whichSetup, zDestOffset, Duration)
end
...
function SetSoundParamsFromLabel     (soundHandle, Label)
end
...
function RegisterStackedSound        (soundHandle, byPosition, width, height)
end
function UnregisterStackedSound      (soundHandle, byPosition, width, height)
end

function SetSoundFacialAnimationLabel(soundHandle, animationLabel)
end
function SetSoundFacialAnimationGroupLabel(soundHandle, Label)
end
...
-- Effects API
--
function AddWeatherEffect            (where, ID)
end
...
-- Ubersplat API
--
function CreateUbersplat             (x, y, name, red, green, blue, alpha, Paused, noBirthTime)
end
...
function BlzCameraSetupApplyForceDurationSmooth     (whichSetup, doPan, dDuration, easeInDuration, easeOutDuration, smoothFactor)
end
...
function BlzFrameGetChildrenCount                   (frame)
end
